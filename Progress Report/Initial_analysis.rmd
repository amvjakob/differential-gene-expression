...
# annotLookup[annotLookup$affy_hg_u133_plus_2 %in% genesStat,]$external_gene_name
# annotLookup[annotLookup$affy_hg_u133_plus_2 %in% genesLogReg,]$external_gene_name
# annotLookup[annotLookup$affy_hg_u133_plus_2 %in% genesSGD,]$external_gene_name

# annotLookup[annotLookup$affy_hg_u133_plus_2 %in% intersect(genesLogReg, genesSGD),]$external_gene_name
# annotLookup[annotLookup$affy_hg_u133_plus_2 %in% intersect(genesLogReg, genesStat),]$external_gene_name
# annotLookup[annotLookup$affy_hg_u133_plus_2 %in% intersect(genesStat, genesSGD),]$external_gene_name
